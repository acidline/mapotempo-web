...
class CustomerTest < ActiveSupport::TestCase
  ...
  test '[tomtom] change device credentials should update vehicles' do
    ...
    assert @customer.vehicles.all?{|vehicle| !vehicle.devices_linking[:tomtom_id] }
  end
  ...
  test '[teksat] change device credentials should update vehicles' do
    ...
    assert @customer.vehicles.all?{|vehicle| !vehicle.devices_linking[:teksat_id]  }
  end
  ...
  test '[orange] change device credentials should update vehicles' do
    ...
    assert @customer.vehicles.all?{|vehicle| !vehicle.devices_linking[:orange_id]  }
  end
